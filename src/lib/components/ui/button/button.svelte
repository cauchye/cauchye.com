	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				brand:
					'bg-brand text-brand-foreground shadow-sm shadow-brand/25 hover:bg-brand/90 hover:shadow-md hover:shadow-brand/25',
				outline:
			...
			size: {
				...
				xl: "h-12 gap-2 rounded-lg px-5 text-[0.9375rem] has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4 [&_svg:not([class*='size-'])]:size-4.5",
				icon: 'size-9',
				'icon-xs':
