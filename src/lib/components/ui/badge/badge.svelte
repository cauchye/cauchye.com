	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				brand: 'bg-brand-subtle text-brand [a]:hover:bg-brand-subtle/70 dark:text-brand',
				eyebrow:
					'h-auto gap-2 rounded-4xl border-border bg-card/60 px-3 py-1 font-mono text-[0.6875rem] tracking-[0.14em] text-muted-foreground uppercase backdrop-blur-sm',
